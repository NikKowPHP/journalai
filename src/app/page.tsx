    ...
    <div className="bg-gray-900 text-white">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="mt-2 text-gray-400">
              Our platform is packed with features to make you interview-ready.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="flex flex-col items-center">
              <div className="text-4xl font-bold text-blue-500 bg-gray-800 rounded-full w-16 h-16 flex items-center justify-center mb-4">
                1
              </div>
              <h3 className="text-xl font-bold mb-2">Select Your Role</h3>
              <p className="text-gray-400">
                Choose your target job, like "Junior Laravel Developer", to
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-400">
                Answer AI-generated questions with your voice and get instant
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-400">
                Monitor your readiness score, review your progress, and walk
      ...
      <section className="bg-blue-600">
        <div className="max-w-4xl mx-auto text-center py-16 px-4">
          ...
          <p className="text-blue-200 mt-2 mb-6">
      ...
      <footer className="bg-gray-900 py-6">
        <div className="max-w-6xl mx-auto px-4 text-center text-gray-500">
          <p>
            © {new Date().getFullYear()} LinguaScribe. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
